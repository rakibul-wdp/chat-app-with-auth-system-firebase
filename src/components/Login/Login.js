...
const Login = () => {
  ...
  return (
    <div>
      <div className='flex justify-center items-center h-[70vh] my-28'>
        <div className='card w-96 bg-base-100 shadow-xl'>
          <div className='card-body'>
            ...
            <button className='btn btn-outline text-lg bg-primary font-bold'>Continue with Facebook</button>
            <button className='btn btn-outline text-lg bg-primary font-bold'>Continue with Github</button>
          </div>
        </div>
      </div>
    </div>
